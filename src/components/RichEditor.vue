<template>
  <div v-if="editor">
    <div :class="{'red-border': showError }" class="options d-flex flex-wrap">
      <div @click="editor.chain().focus().toggleBold().run()" :disabled="!editor.can().chain().focus().toggleBold().run()"
      ...
      <div @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" :class="{
        'text-option': true,
      ...
      <div @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" :class="{
        'text-option': true,
      ...
      <div @click="editor.chain().focus().toggleHeading({ level: 3 }).run()" :class="{
        'text-option': true,
      ...
      <div @click="editor.chain().focus().toggleBulletList().run()" :class="{
        'text-option': true,
      ...
      <div @click="editor.chain().focus().toggleOrderedList().run()" :class="{
        'text-option': true,
      ...
      <div @click="editor.chain().focus().toggleCodeBlock().run()" :class="{
        'text-option': true,
    ...
    <div :class="{ 'edit-box': true, 'red-border': showError, 'gray-text': placeholderShowing }">

<template>
    ...
    <v-btn class="mx-2" @click="loginAsChallenger">Login als user Challenger Eline</v-btn>
    <br>
    <br>
    <v-btn class="mx-2" @click="loginAsMedewerker">Login als user Medewerker Jelle</v-btn>
    <br>
    <br>

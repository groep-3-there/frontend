<template>
    ...
    <v-row>
        <v-col cols="3" class="d-flex align-center justify-start">
            <v-icon>mdi-calendar-blank</v-icon> {{ challenge.createdAt.toLocaleDateString('en-GB') }}
        </v-col>
    ...
    <v-row>
        <v-col cols="10" class="mx-auto">
            ...
            <section>
                ...
                <p><v-icon>mdi-calendar-blank</v-icon> {{ challenge.endDate.toLocaleDateString('en-GB') }}</p>
            </section>
